...
Each tab will represent the value of the "_level_" attribute of each `<c>` tag. 
...
The link between resources is then automatically established by the _dcterms_ _isPartOf_ and _hasPart_ properties.